-- Give aplayer super powers by making them go fast when they touch a speed booster! A Humanoid’s default WalkSpeed property is set to 16. Not so bad, but it’d be a lot cooler to go a lot faster. Make a part that temporarily allows a user to go way faster and then returns them to their original speed after a few seconds. 
